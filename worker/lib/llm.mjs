...
function systemPrompt(publication, allowedCategories) {
  return [
    ...
    `  Choose by the story's SUBJECT, not its source: a central-bank rate decision or`,
    `  monetary-policy story -> "Central Banks"; a bank/company enforcement action ->`,
    `  "Business"; a crypto rule or crypto enforcement -> "Crypto"; an IPO/listing rule`,
    `  -> "IPOs"; inflation/jobs/GDP/trade data -> "Economy"; a market recap -> "US Markets"`,
    `  / "Indian Markets" / "Global Markets" as appropriate. Reserve "Regulation" for`,
    `  securities-fraud / disclosure / market-structure enforcement that doesn't fit the above.`,
